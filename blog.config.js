...
const BLOG = {
  ...
  AUTHOR: "Lee's Blog", // 作者
  BIO: 'Develop Note✍️', // 作者简介
  LINK: 'https://develop-note.vercel.app/', // 网站地址
  KEYWORDS: '', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'poi2003008@naver.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/devNimo', // 你的github个人主页
